  ...
  return (
    <section className="py-10 sm:py-14 lg:py-20 px-4">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center ">
        ...
        <div
          className="shadow-gray-60000 shadow-xl flex flex-col justify-between p-5 sm:p-8 mt-6 sm:mt-8 w-full max-w-md sm:max-w-lg lg:max-w-2xl bg-[#FFE783] rounded-2xl sm:rounded-3xl lg:p-10 h-[350px] min-[430px]:h-[320px] sm:h-[300px] lg:h-[280px] overflow-y-auto"
